...
const PLATFORM_DESCRIPTION =
  "منصة تعليمية تفاعلية تقدّم الدروس بطريقة مبسطة ومنظمة.";
const CONTACT_EMAIL = "aantounyouss@gmail.com";
const COPYRIGHT_TEXT =
  "© 2026 | Antonious Shenouda | " + PLATFORM_NAME;

const SOCIAL_LINKS = {
  facebook: "https://www.facebook.com/madarplatform1/",
  instagram: "https://www.instagram.com/madar_platform_",
  youtube: "https://www.youtube.com/channel/UCwykQ0WgKMCuhxgg65RlNFQ",
...
export default function Footer() {
  ...
  .md-footer {
    ...
    box-shadow: 0 -3px 14px rgba(6, 59, 52, 0.05);
  }
  ...
  @media (max-width: 768px) {
    ...
    .md-footer-desc {
      display: none; /* إخفاء الوصف الطويل على الموبايل */
    }
