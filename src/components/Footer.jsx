...
const PLATFORM_DESCRIPTION = "منصة تعليمية تفاعلية تقدّم الدروس بطريقة مبسطة، منظمة، وتفاعلية تساعد الطالب على الفهم والاستيعاب.";
const CONTACT_EMAIL = "info@example.com"; // TODO: ضع البريد الإلكتروني الحقيقي هنا
const COPYRIGHT_TEXT = "© 2026 جميع الحقوق محفوظة بواسطة | Antonious Shenouda | " + PLATFORM_NAME;

const SOCIAL_LINKS = {
  facebook: "#", // TODO: ضع رابط فيسبوك الحقيقي هنا
  instagram: "#", // TODO: ضع رابط إنستغرام الحقيقي هنا
  youtube: "#", // TODO: ضع رابط يوتيوب الحقيقي هنا
  tiktok: "#", // TODO: ضع رابط تيك توك الحقيقي هنا
...
export default function Footer() {
  return (
    <footer
      ...
      style={{ background: "#FFFFFF", color: "#8A8570", borderTop: "0.5px solid #DED4BD" }}
    >
      {/* تقليص الارتفاع لأقصى درجة ممكنة */}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-1.5 text-xs">
          ...
          <div className="flex items-center gap-2 leading-none">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="font-bold text-xs" style={{ color: "#10665A" }}>{PLATFORM_NAME}</span>
          ...
          {/* المنتصف/اليسار: الروابط، الأيقونات، وحقوق النشر مدمجون في نفس الشريط */}
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
            <div className="flex items-center gap-3">
              <span className="font-medium cursor-default" style={{ color: "#5C5A4A" }}>
                تواصل معنا
              </span>
              <a href={"mailto:" + CONTACT_EMAIL} className="font-medium hover:underline" style={{ color: "#5C5A4A" }}>
                {CONTACT_EMAIL}
              </a>
            </div>
